#' @title Import TPP-TR or TPP-CCR table
#' @description Import a single TPP-CR experiment from file or data frame and convert 
#' it into an ExpressionSet.
#' @details Called by functions \code{\link{tpptrImport}} and \code{\link{tppccrImport}}.
#' @seealso \code{\link{tpptrImport}}, \code{\link{tppccrImport}}.
#' @param dataframe ...
#' @param filename ...
#' @param labels ...
#' @param labelValues numeric vector of values that distinguish each isotope 
#' label. Contains temperature conditions when importing a TPP-TR experiment, and 
#' concentrations when importing an TPP-CCR experiment.
#' @param name character string with name of the imported experiment.
#' @param condition character string naming the experimental condition belonging 
#' to an imported TPP-TR dataset.
#' @param replicate character string naming the experimental replicate belonging 
#' to an imported TPP-TR dataset.
...
#' \code{na.strings} 
#' in function \code{read.delim}.
#' @param type character describing the type of experiment to be imported. Can 
#' either be "CCR" or "TR". The output expressionSet object will be adjusted 
#' accordingly.
#' @import Biobase
#' @import plyr
